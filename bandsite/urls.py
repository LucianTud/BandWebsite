...
urlpatterns = [
    ...
    path('logout/', LogoutView.as_view(), name='logout'),  # folosim LogoutView pentru logout
    path('register/', views.register, name='register'),
    path('members/', views.members, name='members'),
    path('albums/', views.albums, name='albums'),
    path('concerts/', views.calendar_view, name='concerts'),  # doar concerts pentru calendar
    ...
    path('calendar/toggle/', views.toggle_availability, name='toggle_availability'),
]
